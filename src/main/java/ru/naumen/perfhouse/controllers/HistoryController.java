...
public class HistoryController {
    ...
    private List<Constant> constantsList;
    ...
    @Autowired
    public HistoryController(StatDataService service, List<Constant> constantsList) {
    ...
    public ModelAndView nonIndexByDay(@PathVariable("client") String client,
        ...
        Constant constant = getConstantByName(parserName);
        return getDataAndViewByDate(client, constant, year, month, day, parserName);
    }
    ...
    public ModelAndView nonIndexByMonth(@PathVariable("client") String client,
        ...
        Constant constant = getConstantByName(parserName);
        return getDataAndViewByDate(client, constant, year, month, 0, true, parserName);
    }
    ...
    public ModelAndView nonIndexLast3Days(@PathVariable("client") String client,
                                          ...
                                          @PathVariable(name = "parserName") String parserName) throws ParseException {
        Constant constant = getConstantByName(parserName);
        return getDataAndView(client, constant, count, parserName);

    }

    private ModelAndView getDataAndView(String client, Constant constant, int count, String currentParserName)
            throws ParseException {
        StatData data = service.getData(client, constant, count);
        if (data == null) {
            return new ModelAndView(NO_HISTORY_VIEW);
        }
    ...
    private ModelAndView getDataAndViewByDate(String client, Constant constant, int year, int month, int day, String currentParserName)
            throws ParseException {
        return getDataAndViewByDate(client, constant, year, month, day, false, currentParserName);
    }

    private ModelAndView getDataAndViewByDate(String client, Constant constant, int year, int month, int day,
                                              boolean compress, String currentParserName) throws ParseException {
        StatData dataDate = service.getDataDate(client, constant, year, month, day);
        if (dataDate == null) {
            return new ModelAndView(NO_HISTORY_VIEW);
        }
    ...
    private ModelAndView getDataAndViewCustom(String client, Constant constant, String from, String to, int maxResults,
                                              String currentParserName) throws ParseException {
        StatData data = service.getDataCustom(client, constant, from, to);
        if (data == null) {
            return new ModelAndView(NO_HISTORY_VIEW);
        }
    ...
    public ModelAndView customActions(@PathVariable("client") String client, @RequestParam("from") String from,
                                      ...
                                      @PathVariable(name = "parserName") String parserName) throws ParseException {
        Constant constant = getConstantByName(parserName);
        return getDataAndViewCustom(client, constant, from, to, count, parserName);
    }

    private Constant getConstantByName(String name) {
